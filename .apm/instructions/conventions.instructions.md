---
description: Working notes for maintainers and AI agents authoring the juspay-checkout-skills skill bank. The structural framework lives in docs/framework.md; this file covers source-of-truth discipline, doc-fetching shortcuts, the Phase 1 scope, grounded reference data (verified merchant-enablement gates, endpoint inventory), and the multi-agent install matrix.
---
...
Verified against `euler-workspace-5/`. Use when authoring skills.
